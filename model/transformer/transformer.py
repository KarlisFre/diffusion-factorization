...
import model.transformer.attention_layer as attention_layer
import model.transformer.beam_search as beam_search
import model.transformer.ffn_layer as ffn_layer
import model.transformer.model_utils as model_utils
import model.transformer.position_embedding as position_embedding
...
class Transformer(tf.keras.Model):
    ...
    def __init__(self, params, name=None):
        ...
        self.embedding_replacement = Dense(self.params["hidden_size"])
        self.output_dense = Dense(self.params["n_classes"], dtype=tf.float32)
    ...
    def call(self, inputs, training, log_in_tb=False):
        ...
        with tf.name_scope("Transformer"):
            ...
            if self.params["encoder_only"]:
                return self.output_dense(encoder_outputs)

            targets = inputs
            logits = self.decode(targets, encoder_outputs, attention_bias, training)
            return self.output_dense(logits)
    ...
    def encode(self, inputs, attention_bias, training):
        ...
        with tf.name_scope("encode"):
            ...
            # applying dropout.
            embedded_inputs = self.embedding_replacement(inputs)
    ...
    def decode(self, targets, encoder_outputs, attention_bias, training):
        ...
        with tf.name_scope("decode"):
            ...
            decoder_inputs = self.embedding_replacement(targets)
    ...
    def _get_symbols_to_logits_fn(self, max_decode_length, training):
        ...
        def symbols_to_logits_fn(ids, i, cache):
            ...
            decoder_input = tf.expand_dims(ids[:, -1:], axis=-1)

            # Preprocess decoder input by getting embeddings and adding timing signal.
            decoder_input = self.embedding_replacement(decoder_input)
